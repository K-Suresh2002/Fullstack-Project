...
from .views import RegisterView,LoginView, BusListCreativeView, BusDetailView, UserBookingView, BookingView

urlpatterns = [
    path('buses/', BusListCreativeView.as_view(), name = 'buslist'),
